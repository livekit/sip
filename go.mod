...
require (
	...
	github.com/livekit/server-sdk-go/v2 v2.2.1-0.20240702001219-93c9f96c6d5f
...
replace github.com/emiago/sipgo => github.com/livekit/sipgo v0.13.2-0.20240523154935-38b4a6ef60b0
